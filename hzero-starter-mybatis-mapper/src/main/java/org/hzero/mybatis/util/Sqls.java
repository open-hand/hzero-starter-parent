 ...
 * SQL工具类
 *
 * @author xianzhi.chen@hand-china.com	2018年9月8日下午3:06:06
 */
public class Sqls {
    ...
    public Sqls andIn(String property, Iterable values, boolean ignoreEmpty) {
        if (ignoreEmpty && (values == null || !values.iterator().hasNext())) {
            return this;
        }
        this.criteria.criterions.add(new Criterion(property, values, "in", "and"));
        return this;
    ...
    public Sqls andNotIn(String property, Iterable values, boolean ignoreEmpty) {
        if (ignoreEmpty && (values == null || !values.iterator().hasNext())) {
            return this;
        }
        this.criteria.criterions.add(new Criterion(property, values, "not in", "and"));
