...
public class ExcelExporterV2 implements IExcelExporter {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(ExcelExporterV2.class);
     ...
     */
    public ExcelExporterV2(ExportColumn root, String fillerType,
                           int singleExcelMaxSheetNum, int singleSheetMaxRow) {
        this.excelFiller = ExcelFillerHolder.getExcelFillerV2(fillerType, root);
