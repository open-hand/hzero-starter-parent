...
public class SqlserverTableMetaCache extends AbstractTableMetaCache {
    ...
    protected TableMeta fetchSchema(Connection connection, String tableName) throws SQLException {
        String sql = "SELECT TOP 1 * FROM " + keywordChecker.checkAndReplace(tableName);
    ...
    private TableMeta resultSetMetaToSchema(String schemaName, String catalogName, ResultSetMetaData rsmd, DatabaseMetaData dbmd)
            throws SQLException {
        /*
